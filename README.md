# dragon-ball-ui-automation
UI Automation project using Playwright, Pytest and Allure.  Tests dynamic infinite scroll and verifies all Dragon Ball characters are loaded.
